...
app.get('/laptops/:id', (req, res) => {
    ...
    const data = laptops[laptops.findIndex(temp => temp.id == id)]
...
//Insert laptops Data
app.post('/insertLaptops', (req, res) => {
...
//Update Laptops Data
app.patch("/updatalaptops/:id", (req, res) => {
    const id = req.params.id;

    const index = laptops.findIndex(temp => temp.id == id);

    laptops[index] = req.body;
...
//ramsize grater then 30000
app.get('/ramsize/more/:num',(req,res)=>{
