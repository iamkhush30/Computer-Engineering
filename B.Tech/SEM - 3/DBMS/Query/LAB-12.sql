...
create table Department (DepartmentID int Primary Key, DepartmentName Varchar (100) Not Null Unique)
...
create table Designation(DesignationID Int Primary Key, DesignationName Varchar (100) Not Null Unique)
